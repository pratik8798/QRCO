...
public class OCR extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.example.dell.qrco";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!textRecognizer.isOperational())
        {
            ...
            cameraSource = new CameraSource.Builder(getApplicationContext(),textRecognizer)
                    ...
                    .setRequestedPreviewSize(1280,1024) // width,ht of camera pixel frames
    ...
    public void switch_to_user_info(View v){
        Intent intent = new Intent(this,QRGenerator_Intent.class );
